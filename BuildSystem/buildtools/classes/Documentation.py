    ...
    def Build(self):
        ...
        for i in range(0,3):
          if Globals.operating_system_ != "windows":
            # Create CASAL2.aux
            if os.system('latexmk -pdf --interaction=nonstopmode CASAL2') != EX_OK:
              return False
            # Create the bibliography
            if os.system('bibtex CASAL2') != EX_OK:
              return False
            # Fix the references/citations
            if os.system('latexmk -pdf --halt-on-error --interaction=nonstopmode CASAL2') != EX_OK:
              return False
            ...
            if os.system('latexmk.exe -pdf --enable-installer CASAL2') != EX_OK:
              return Globals.PrintError('latexmk -pdf failed')
            if os.system('bibtex.exe CASAL2') != EX_OK:
              return Globals.PrintError('bibtex failed')
            if os.system('latexmk.exe -pdf --halt-on-error --enable-installer CASAL2') != EX_OK:
              return Globals.PrintError('latexmk -pdf failed')
        ...
        for i in range(0,3):
          if Globals.operating_system_ != "windows":
            if os.system('latexmk -pdf --interaction=nonstopmode GettingStartedGuide') != EX_OK:
              return False
            if os.system('bibtex GettingStartedGuide') != EX_OK:
              return False
            if os.system('latexmk -pdf --halt-on-error --interaction=nonstopmode GettingStartedGuide') != EX_OK:
              return False
            ...
            if os.system('bibtex.exe GettingStartedGuide') != EX_OK:
              return Globals.PrintError('bibtex failed')
            if os.system('latexmk.exe -pdf --halt-on-error --enable-installer GettingStartedGuide') != EX_OK:
              return Globals.PrintError('latexmk -pdf failed')
        ...
        for i in range(0,3):
          if Globals.operating_system_ != "windows":
            if os.system('latexmk -pdf --halt-on-error --interaction=nonstopmode ContributorsGuide') != EX_OK:
              return False
          else:
            if os.system('latexmk.exe -pdf --halt-on-error --enable-installer ContributorsGuide') != EX_OK:
              return Globals.PrintError('latexmk -pdf failed')
